...
interface BusinessPayablesChartProps {
  payables: Array<{ date: string; amount: number; status: string }>;
}

export function BusinessPayablesChart({ payables }: BusinessPayablesChartProps) {
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        <CardTitle className="text-base font-medium">Hutang Usaha</CardTitle>
